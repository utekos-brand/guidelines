...
render(
  <Theme name="...">
    <VisibilityByTheme visible="sbanken">Only shown in Sbanken theme</VisibilityByTheme>

    <VisibilityByTheme hidden="eiendom">Only hidden in Eiendom theme</VisibilityByTheme>

    <VisibilityByTheme visible={["sbanken", "eiendom"]}>
      Only shown in Sbanken or Eiendom theme
    </VisibilityByTheme>

    <VisibilityByTheme visible={[{ name: "sbanken" }, { name: "eiendom" }]}>
      Only shown in Sbanken or Eiendom theme
    </VisibilityByTheme>

    <VisibilityByTheme visible={[{ name: "sbanken" }, { name: "eiendom", variant: "blue" }]}>
      Only shown in Sbanken then or Eiendom theme – that also includes the fictive variant="blue".
    </VisibilityByTheme>
  </Theme>,
);
```
