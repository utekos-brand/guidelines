...
Spor-komponenter har en systematisk bruk av design-tokens for å vise interaktive tilstander. Vi ønsker at brukeren skal kunne gjenkjenne lik interaksjon uavhengig av om de er på web eller i app, eller om de trykker på en knapp eller legger til et dokument.
